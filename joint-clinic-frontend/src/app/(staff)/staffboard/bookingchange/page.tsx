            ...
            <DashBoardContent>
                ...
                <div className="booking-change-container w-full h-full flex flex-col gap-y-6 sm:gap-y-8 md:bg-white md:rounded-[20px] md:shadow-[0px_10px_30px_10px_rgba(0,0,0,0.08)] p-4 sm:p-6 md:p-5 md:overflow-y-auto md:custom-scrollbar">
                    ...
                    <div className="booking-change-right rightside flex flex-col w-full px-2 sm:px-4 md:px-0">
                        ...
                        />
                        {/* <pre></pre> */}
                        <h3 className="text-[20px] text-base sm:text-lg md:text-[20px] text-[#1E5598] font-bold my-3 sm:my-4 md:my-[15px] text-center md:text-left">
                            Patient Booking was on:{" "}
                            <span style={{ color: colorConst.info}} className="block sm:inline text-[20px] mt-1 sm:mt-0">
                                {oldDate} at {oldTime}
                            </span>
                        </h3>
                        <h3 className="text-[20px] text-base sm:text-lg md:text-[20px] text-[#1E5598] font-bold text-center md:text-left">
                            Patient Booking will be on:{" "}
                            <span style={{ color: colorConst.success }} className="block sm:inline text-[20px] mt-1 sm:mt-0">
