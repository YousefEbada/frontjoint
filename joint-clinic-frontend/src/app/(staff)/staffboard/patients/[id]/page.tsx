                    ...
                    <div className="flex flex-col w-full gap-4">
                        <div className="flex justify-between w-full items-start">
                            <div className="flex flex-col gap-1">
                                ...
                                <Link href={`/staffboard/patients/${params.id}/personal-details`} className="underline text-[#0D294D] font-medium text-sm">View Personal Details</Link>
                            </div>
                            <div className="flex flex-col gap-2 items-end">
                                <Link href="/staffboard/reports" className="underline text-[#1E5598] font-bold text-base">View Reports</Link>
